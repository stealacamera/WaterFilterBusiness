...
namespace WaterFilterBusiness.DAL.Migrations
{
    ...
    [Migration("20240331173839_UpdatedAccordingToNewDocumentation")]
    partial class UpdatedAccordingToNewDocumentation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaterFilterBusiness.DAL.Entities.RedListedCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("RedListedCustomers", (string)null);
                });
            ...
            modelBuilder.Entity("WaterFilterBusiness.DAL.Entities.RedListedCustomer", b =>
                {
                    b.HasOne("WaterFilterBusiness.DAL.Entities.Customer", null)
                        .WithOne()
                        .HasForeignKey("WaterFilterBusiness.DAL.Entities.RedListedCustomer", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
